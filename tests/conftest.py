...
# WARNING: Ensure imports from `auto_test11` comes after this line
from auto_test11 import app, settings, db  # noqa
from auto_test11.cli import create_user, cli  # noqa
