...
- 🎯 Entry points to execute your program using `python -m <auto_test11>` or `$ auto_test11` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/shetuayalew/auto_test11/branch/main/graph/badge.svg?token=auto_test11_token_here)](https://codecov.io/gh/shetuayalew/auto_test11)
[![CI](https://github.com/shetuayalew/auto_test11/actions/workflows/main.yml/badge.svg)](https://github.com/shetuayalew/auto_test11/actions/workflows/main.yml)

Awesome auto_test11 created by shetuayalew

## Install

from source
```bash
git clone https://github.com/shetuayalew/auto_test11 auto_test11
cd auto_test11
make install
```
...
```bash
pip install auto_test11
```

## Executing

```bash
$ auto_test11 run --port 8080
```

or

```bash
python -m auto_test11 run --port 8080
```

or

```bash
$ uvicorn auto_test11:app
```
...
```bash
❯ auto_test11 --help
Usage: auto_test11 [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ auto_test11 create-user --help
Usage: auto_test11 create-user [OPTIONS] USERNAME PASSWORD
...
```bash
auto_test11 create-user admin admin --superuser
```
...
Run with `auto_test11 run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `auto_test11 create-user`.
...
-----------------------------------------------------
auto_test11/__init__.py              4      0   100%
auto_test11/app.py                  16      1    94%
auto_test11/cli.py                  21      0   100%
auto_test11/config.py                5      0   100%
auto_test11/db.py                   10      0   100%
auto_test11/models/__init__.py       0      0   100%
auto_test11/models/content.py       47      1    98%
auto_test11/routes/__init__.py      11      0   100%
auto_test11/routes/content.py       52     25    52%
auto_test11/routes/security.py      15      1    93%
auto_test11/routes/user.py          52     26    50%
auto_test11/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in auto_test11/default.toml.
